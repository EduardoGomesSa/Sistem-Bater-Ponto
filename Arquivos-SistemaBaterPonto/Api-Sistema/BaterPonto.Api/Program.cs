...
builder.Services.AddScoped<IRequestHandler<AdicionarCargo, bool>, CadastroCargoHandler>();
builder.Services.AddScoped<IRequestHandler<MudarCargoDeFuncionario, bool>, CadastroFuncionarioHandler>();
